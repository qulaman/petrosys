        ...
        <div className="overflow-x-auto rounded-lg border">
          <table className="w-full text-sm">
            <thead className="bg-muted/50 text-left">
              <tr><th className="px-3 py-2">Время</th><th className="px-3 py-2">Машина</th><th className="px-3 py-2">Водитель</th><th className="px-3 py-2">Маршрут</th></tr>
            </thead>
            <tbody className="divide-y">
              ...
              {rows.length === 0 ? <tr><td colSpan={4} className="px-3 py-6 text-center text-muted-foreground">Нет рейсов за период</td></tr> : null}
            </tbody>
          </table>
        </div>
      </div>
